    ...
    <header className="fixed top-0 left-0 right-0 z-30 flex items-center justify-between p-4 sm:p-6 pointer-events-none pt-safe">
      ...
      <div className="flex items-center gap-3 pointer-events-auto">
        <button
          ...
          className="w-10 h-10 rounded-full glass-pill border border-white/10 flex items-center justify-center text-neutral-300 hover:text-white hover:border-white/25 active:scale-95 transition-all shadow-sm backdrop-blur-md"
        >
          {isMuted ? (
